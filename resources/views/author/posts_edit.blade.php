...
<div class="section-body">
    <form action="{{ route('author_post_update',$posts->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="text-center">Edit Post (As a Author)</h4>
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <table class="table table-bordered">
                                @foreach ($existing_tags as $tag)
                                    <tr>
                                        <td>{{ $tag->tag_name }}</td>
                                        <td><a href="{{ route('author_post_tag_delete',[$tag->id,$posts->id]) }}" onClick="return confirm('Are you sure?');">Delete</a></td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
