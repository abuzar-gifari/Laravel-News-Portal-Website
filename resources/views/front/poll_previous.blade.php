            ...
            <div class="col-md-12">
                ...
                <nav class="breadcrumb-container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ PREVIOUS_POLL }}</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @foreach ($online_poll_data as $item)
                    <!-- 1st poll item should not be shown -->
                    @if ($loop->iteration == 1)
                        @continue
                    @endif
                    ...
                    <div class="poll-item">
                        ...
                        <div class="poll-date">
                            <span><b>{{ POLL_DATE }}: </b></span>
                            @php
                                $ts = strtotime($item->created_at);
                                $created_at = date('d F, Y',$ts);
                            @endphp
                            
                            <a href="javascript:void;">{{ $created_at }}</a>
                        </div>
