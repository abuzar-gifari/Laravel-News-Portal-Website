...
class AuthorPostController extends Controller
{
    ...
    public function create(){
        ...
        return view('author.posts_create',compact('subcategories'));
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('author_post_show')->with('success_message','Post Created Successfully');
    }
    ...
    public function edit($id){
        ...
        // check if it is author or not
        $if_its_author = Post::where('id',$id)->where('author_id',Auth::guard('author')->user()->id)->count();
        if (!$if_its_author) {
        ...
        $subcategories = SubCategory::with('rCategory')->get();
        return view('author.posts_edit',compact('posts','subcategories','existing_tags'));
    }
    ...
    public function delete_tag($id,$post_id){
        ...
        $tag->delete();
        return redirect()->route('author_post_edit',$post_id)->with('success_message','Data is Deleted Successfully');
    }
    ...
    public function update(Request $request,$id){
        ...
        return redirect()->route('author_post_show')->with('success_message','Post Updated Successfully');
    }
    ...
    public function delete($id){
        ...
        return redirect()->route('author_post_show')->with('success_message','Data is Deleted Successfully');
    }
